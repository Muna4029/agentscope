...
from ..message import TextBlock, ThinkingBlock, ToolUseBlock
...
class ZhipuChatModel(ChatModelBase):
    ...
    async def __call__(
        ...
        tool_choice: (
            Literal["auto", "none", "any", "required"] | str | None
        ) = None,
    ...
    def _parse_zhipu_completion_response(
        ...
        """Given a Zhipu AI chat completion response object, extract the
    ...
    def _format_tool_choice(
        ...
        if tool_choice in ["auto", "none"]:
            ...
            logger.warning(
                "Zhipu AI doesn't support tool_choice='any', using 'auto'."
            )
            return "auto"
        elif tool_choice == "required":
            # Zhipu AI doesn't support "required", use "auto" instead
            logger.warning(
                "Zhipu AI doesn't support tool_choice='required', use 'auto'."
            )
            return "auto"
        else:
            # Specific tool name
